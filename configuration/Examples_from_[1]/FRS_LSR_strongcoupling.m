...
% a single sector and generates the results shown in Fig. 12b of the paper 
...
sys.kappa_c = 0.5;         % Linear coupling strength
...
simsetup.SynchronizationSingleSectorAnalytical.r_range = [0.99 1.19];
