...
% Range
simsetup.VariationCouplingAndClearance.Range_kappa_c = [1e-2,3];
...
simsetup.VariationCouplingAndClearance.Number_kappa_c = 3;

% Parameters of nominal clearance normalized by tuned resonance amplitude
% Range
simsetup.VariationCouplingAndClearance.Range_GammaScale = [0.1,0.5];
% Scaling of discrete points in interval
...
simsetup.VariationCouplingAndClearance.N_rSteps = 3;